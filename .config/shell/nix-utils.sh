...
nix_pkgs_only() {
  ...
  #? usage: nix_pkgs_only [-f] .#nixosConfigurations.xiaomi-A35S-laptop-nixos.config.system.build.toplevel
  local opts=()
...
nix_home_manager_reload() {
  NIX_REPL=/home/evadev/projects/barsik-config/repl.nix

  NIX_FILE="/home/evadev/projects/barsik-config/home"
...
nix_hot_reload_noctalia() {
  ...
  NIX_FILE="/home/evadev/projects/barsik-config/home/desktop/manager/niri/quickshell/noctalia.nix"
  NIX_EVAL='home.xdg.configFile."noctalia/settings.json"'
  CONFIG_LOCATION=/home/evadev/.config/noctalia/settings.json
  CALLBACK="systemctl --user restart noctalia"
...
nix_hot_reload_niri() {
  ...
  NIX_FILE="/home/evadev/projects/barsik-config/home/gui/niri.nix"
  NIX_EVAL='home.xdg.configFile."niri/config.kdl"'
  CONFIG_LOCATION=/home/evadev/.config/niri/config.kdl
  CALLBACK=""
